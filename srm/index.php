...
<head>
  ...
  <style>
	...
	background: url("assests/image/Capture.png") no-repeat center center fixed;}
...
<body>
  <div id="chat" class="col-sm-4">
    <div id="chat-circle">
      ...
      <img src="assests/image/icon.png" style="border-radius: 50%;
      width: 100%;" alt="chat">
    </div>
    <div class="chat-box" style="display: none;">
      <div class="chat-box-header">SRM-ChatBot<span class="chat-box-toggle"> <i class="material-icons">close</i> </span>
      </div>
      <div class="chat-box-body">
        ...
        <?php if(!isset($_SESSION['s_email'])){?>
          <form id='usr-details' autocomplete="off" name="usr-details"  >
            <div id="cm-msg-0" class="chat-msg user" >
               <span class="msg-avatar"> <img src="assests/image/icon.png">
              </span>
              <br><br>
        ...
        <?php }else { ?>
          ...
          <div id="cm-msg-0" class="chat-msg user">
          <span class="msg-avatar"> <img src="assests/image/icon.png"> </span>
          <div class="cm-msg-text">Hello I'm SRM Chat-Bot (beta)</div>
        </div>
